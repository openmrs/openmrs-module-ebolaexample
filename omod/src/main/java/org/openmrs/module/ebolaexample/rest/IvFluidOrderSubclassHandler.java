...
public class IvFluidOrderSubclassHandler extends BaseDelegatingSubclassHandler<Order, IvFluidOrder> implements DelegatingSubclassHandler<Order, IvFluidOrder> {
    @Override
